...
try:
    if RELEASE_LEVEL == "RELEASE":
        logo = Figlet(font="sblood")
        cprint(logo.renderText("Flask/React"), color="cyan", attrs=["bold"])
...
class Logger:
    ...
    def __init__(self, name):
        ...
        coloredlogs.install(level=None, isatty=True)
    ...
    def critical_sync(self, message):
        """
        Log a critical message.
        """
        self.logger.critical(message)
